  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mx-auto">
        <div className="container w-4/5 flex flex-col items-center">
          <h2 className="mt-24 mb-12 text-justify lg:w-4/5 text-2xl">
            I&apos;m&nbsp;focusing on improving my knowledge with hard work and
            determination. I want to follow a <strong>MERN</strong> tech stack,
            while also learning SQL based databses and NextJs. Here are some of
            the major languages, frameworks, and other tools that
            I&apos;ve&nbsp;worked with:
          </h2>
        </div>
